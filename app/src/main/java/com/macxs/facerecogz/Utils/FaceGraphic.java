...
public class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    Paint choosenLabelColor;
    Paint choosenBoxColor;

    private volatile Face face;
    private Boolean isRegister = true;

    public FaceGraphic(GraphicOverlay overlay, Face face, int labelColor, int boxColor, boolean isRegistration) {
        super(overlay);
        ...
        facePositionPaint.setColor(labelColor);
        ...
        choosenLabelColor = new Paint();
        choosenLabelColor.setColor(labelColor /* background color */);
        choosenLabelColor.setStyle(Paint.Style.FILL);
        this.choosenBoxColor = new Paint();
        choosenBoxColor.setColor(boxColor);
        choosenBoxColor.setStyle(Paint.Style.STROKE);
        choosenBoxColor.setStrokeWidth(BOX_STROKE_WIDTH);
...
//        canvas.drawRect(left, top, right, bottom, boxPaints[colorID]);
        canvas.drawRect(left, top, right, bottom, choosenBoxColor);
